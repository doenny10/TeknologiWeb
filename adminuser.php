			...
			<div id="navbar" class="row" style="background-color: #f1885b">
				<div class="col-lg-12" >
					<nav class="nav nav-pills nav-fill">
			  			<a class="nav-item nav-link active" href="adminuser.php"><img src="[navbar]useradmin.png" height="50px" width="70px"></a>
		...
		<table class="table table-bordered text-center" style="border:1px solid black;">
			...
			<tbody style="border:3px solid black;">
  				...
  				<tr>
  					...
  					<td style="border:3px solid black;"> <?php echo $pecah['name']; ?> </td>
  					<td style="border:3px solid black;"> <?php echo $pecah['username']; ?> </td>
  					<td style="border:3px solid black;"> <?php echo $pecah['password']; ?> </td>
  					<td style="border:3px solid black;"> <?php echo $pecah['email']; ?> </td>
  					<td style="border:3px solid black;"> <?php echo $pecah['address']; ?> </td>
  					<td style="border:3px solid black;"> <?php echo $pecah['gender']; ?> </td>
  					...
  					<td style="border:3px solid black;"> 
						...
						<a href="edituser.php?id=<?php echo $pecah['id']; ?>"> <button class="btn btn-sm btn-success"> <img src="edit.png" width=20 height=20></button></a>
					</td style="border:3px solid black;">
						<td style="border:3px solid black;"> 
						<a href="deleteuser.php?id=<?php echo $pecah['id']; ?>" > <button  name = "delete" class="btn btn-sm btn-danger" onClick="return confirm('Are You Sure ?')"> <img src="delete.svg" width=20 height=20> </button> </a>
						</td>
  				</tr>
  				<?php } ?>
  			</tbody>
