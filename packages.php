 				 		...
 				 		<?php
   					 	...
   					 	if(isset($_SESSION['user'])){
   					 		echo '<form class="px-4 py-3" action="database.php" method="POST">
							  		...
							  		<button class="dropdown-item" name="destroypackages" id="destroypackages" href="database.php"><span class="fa fa-sign-out"></span> Log Out </button>
							  </form>';   					 		
   					 	}
   					 	elseif(empty($_SESSION['user'])){
   					 		echo '<form class="px-4 py-3" action="database.php" method="POST">
						    ...
						    <button type="submit" class="btn btn-primary" name="signinpackages" id="signinpackages"><span class="fa fa-user-circle"></span> Sign in</button> 
						</form>
			...
			<div id="navbar" class="row" style="background-color: #f1885b">
				<div class="col-lg-12" >
					<nav class="nav nav-pills nav-fill">
						...
						<a class="nav-item nav-link active" href="packages.php"><img src="[navbar] packages.png" height="50px" width="70px"></a>
					</nav>
				</div>
			</div>
			<!-- ====================================================================================================================== -->
			    ...
			    <div class="col-sm-10">
					...
					<div id="isi" class="row justify-content-md-center">
						<div class="col-md-6 d-flex justify-content-center" >
							<div class="col-md-6 d-flex justify-content-center" >
					      		<a href="#"><img src="paket1.png" width="200px"></a>
					      	</div>
					      	<div class="col-md-6 d-flex justify-content-center" >
					      		PAKET 1 - PAKET HORE
								<br>
								• Spaghetti Bolognese<br>
								• Chocolate with bubble<br>
								• CupcakesSpaghetti Bolognese<br>
								• Chocolate with bubble<br>
								• Cupcakes<br>
					      	</div>
					    </div>
					    ...
					    <div class="col-md-6 d-flex justify-content-center" >
					      	<div class="col-md-6 d-flex justify-content-center" >
					      		<a href="#"><img src="paket2.png" width="200px"></a>
					      	</div>
					      	<div class="col-md-6 d-flex justify-content-center" >
					      		PAKET 2 - PAKET MANIA
								<br>
					      		• Macaroni Chesee<br>
								• Fusili Korean<br>
								• Chocolate with Coffe jelly<br>
								• Cappucino with bubble<br>
								• Brownies<br>
					      	</div>
					    </div> 
					</div>
					...
					<div id="isi" class="row justify-content-md-center">
						<div class="col-md-6 d-flex justify-content-center" >
							<div class="col-md-6 d-flex justify-content-center" >
					      		<a href="#"><img src="paket3.png" width="200px"></a>
					      	</div>
					      	<div class="col-md-6 d-flex justify-content-center" >
					      		PAKET 3 - PAKET SERU
								<br>
					      		• Spaghetti Mushroom<br>
								• Chocolate with buble<br>
								• Cappucino with Grass Jelly<br>
								• Macaroni Sekotel<br>
					      	</div>
					    </div>
					    <div class="col-md-6 d-flex justify-content-center" >
					      		<div class="col-md-6 d-flex justify-content-center" >
					      		<a href="#"><img src="paket4.png" width="200px"></a>
					      	</div>
					      	<div class="col-md-6 d-flex justify-content-center" >
					      		PAKET 4 - PAKET ASIK
								<br>
