			...
			<!-- ====================================================================================================================== -->
				...
				<div class="col-md-4">
					...
					<div class="form-group">
		    			...
		    			<input type="text" class="form-control" id="optional" name = "optional" placeholder="Optional" value="">
		  			</div>
		  			...
		  			<div class="form-group">
		  				<label for="labelEmail">Category</label><br>
		    			<select name = "category" id="category" placeholder="Category" style="width: 470px; height: 50px;">
		  			...
		  			<div class="form-group">
		    			...
		    			<input type="text" style="width:470px; height:150px;" rows="5" cols="40"  class="form-control" id="description" name = "description" placeholder="Description" value="">
		  			</div>

		  			<div class="form-group">
		    			<label for="labelEmail">Photo</label>
		    			<input type="text" class="form-control" id="photo" name = "photo" placeholder="Photo" value="">
		  			</div>
		    		<button type="submit" class="btn btn-primary" name="addmenu" id="addmenu">Save</button>
		  		</div>		  		
