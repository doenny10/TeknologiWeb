 				 		...
 				 		<?php
   					 	...
   					 	if(isset($_SESSION['user'])){
   					 		echo '<form class="px-4 py-3" action="database.php" method="POST">
							  		...
							  		<button class="dropdown-item" name="destroyother" id="destroyother" href="database.php"><span class="fa fa-sign-out"></span> Log Out </button>
							  </form>';   					 		
   					 	}
   					 	elseif(empty($_SESSION['user'])){
   					 		echo '<form class="px-4 py-3" action="database.php" method="POST">
						    ...
						    <button type="submit" class="btn btn-primary" name="signinother" id="signinother"><span class="fa fa-user-circle"></span> Sign in</button> 
						</form>
			...
			<div id="navbar" class="row" style="background-color: #f1885b">
				<div class="col-lg-12" >
					<nav class="nav nav-pills nav-fill">
						...
						<a class="nav-item nav-link active" href="other.php"><img src="[navbar] drink.png" height="50px" width="70px"></a>
			...
			<div class="row">
			    ...
			    <div class="col-sm-10">
					...
					<div class="col-md-6 d-flex justify-content-center" >
						...
						<div class="col-md-6 d-flex justify-content-center" >
				      		<a href="#"><img src="drink.png" width="200px"></a>
				      	</div>
				      	<div class="col-md-6 d-flex justify-content-center" >
				      		MILK TEA
							<br>
					      	Tersedia dengan varian rasa coklat dan cappucino, anda juga dapat menambahkan bubble drink / grass jelly / coffe jelly sesuai selera 
				      	</div>
   						 <div class="row justify-content-md-center">
   						 	...
   						 	<div class="col-md-3 d-flex justify-content-center" >
								<select id="lunch" class="selectpicker" title="select taste">
							        <option>Coklat</option>
							        <option>Moccacino</option>
						    	</select>
   						 	</div>
   						 	<div class="col-md-3 d-flex justify-content-center" >
								<select id="lunch" class="selectpicker" title="select topping">
							        <option>Bubble</option>
							        <option>Grass Jelly</option>
							        <option>Coffe Jelly</option>
						    	</select>
   						 	</div>
				    ...
				    <div class="col-md-6 d-flex justify-content-center" >
						<div class="row justify-content-md-center">
						<div class="col-md-6 d-flex justify-content-center" >
				      		<a href="#"><img src="cake1.png" width="200px"></a>
				      	</div>
				      	<div class="col-md-6 d-flex justify-content-center" >
				      		MACARONI SEKOTEL
							<br>
					      	Makaroni yang dipanggang bersama dengan sauce special dangan keju dan daging.
				      	</div>
   						 <div class="row justify-content-md-center">
					...
					<div class="col-md-6 d-flex justify-content-center" >
						<div class="row justify-content-md-center">
						<div class="col-md-6 d-flex justify-content-center" >
				      		<a href="#"><img src="cake2.png" width="200px"></a>
				      	</div>
				      	<div class="col-md-6 d-flex justify-content-center" >
				      		BROWNIES
							<br>
					      	Bronies coklat dengan rasa yang khas
				      	</div>
   						 <div class="row justify-content-md-center">
   						 	<div class="col-md-6 justify-content-center" >
   						 		<b>Rp. 20.000</b>
				    ...
				    <div class="col-md-6 d-flex justify-content-center" >
						<div class="row justify-content-md-center">
						<div class="col-md-6 d-flex justify-content-center" >
				      		<a href="#"><img src="cake3.png" width="200px"></a>
				      	</div>
				      	<div class="col-md-6 d-flex justify-content-center" >
				      		CUP CAKES
							<br>
					      	Cup cake dengan toping cream lembut diatasnya dan dilengkapi dengan taburan choco chips yang renyah
				      	</div>
   						 <div class="row justify-content-md-center">
   						 	<div class="col-md-6 justify-content-center" >
   						 		<b>Rp. 5.000</b>
					...
					<div id="isi" class="row justify-content-md-center">
						<div class="col-md-6 d-flex justify-content-center" >
							<div class="col-md-6 d-flex justify-content-center" >
					      		<!--<a href="#"><img src="menu5.png" width="200px"></a>-->
					      	</div>
					      	<div class="col-md-6 d-flex justify-content-center" >
					      		<!--FUSILI
								<br>
					      		Fusilli merupakan salah satu pasta yang bentuknya spiral. Fusilli biasanya diolah dengan saus krim dan kacang polong.-->
					      	</div>
					    </div>
					    <div class="col-md-6 d-flex justify-content-center" >
					      		<div class="col-md-6 d-flex justify-content-center" >
