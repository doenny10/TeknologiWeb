					...
					<!-- form drop down -->
			 		<div class="dropdown-menu">
					  	<form class="px-4 py-3" action="database.php" method="POST">
						    ...
						    <br>
						    <button type="submit" class="btn btn-primary" name="signin" id="signin"><span class="fa fa-user-circle"></span> Sign in</button> 
						</form>
	...
	<div class="col-md-12" style="z-index: 0;">
		...
		<div class="row">
		    ...
		    <div class="col-sm-10">
				...
				<div id="isi" class="row justify-content-md-center">
					<div class="col-md-6 d-flex justify-content-center" >
				      	<a href="#"><img src="promo3.jpg"></a>
				    </div>
				    <div class="col-md-6 d-flex justify-content-center" >
				      	<a href="#"><img src="promo4.jpg"></a>
				    </div>
