...
<body style="background-image: url(cream.jpg)">
				...
				<div class="btn-group">
					...
					<div class="dropdown-menu">
						...
						if(isset($_SESSION['user'])){
							...
							<button class="dropdown-item" name="transaksi" id="transaksi" href="mytranscation.php"><span class="fa fa-credit-card-alt"></span> My Transaction </button>
							<button class="dropdown-item" name="settings" id="settings" href="settings.php"><span class="fa fa-cog"></span> Settings </button>
							<button class="dropdown-item" name="destroypasta" id="destroypasta" href="database.php"><span class="fa fa-sign-out"></span> Log Out </button>
							</form>';   					 		
						}
						elseif(empty($_SESSION['user'])){
							echo '<form class="px-4 py-3" action="database.php" method="POST">
							...
							<button type="submit" class="btn btn-primary" name="signinpasta" id="signinpasta"><span class="fa fa-user-circle"></span> Sign in</button> 
							</form>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="register.php"><span class="fa fa-user-plus"></span> New around here? Sign up</a>
							<a class="dropdown-item" href="#"> <span class="fa fa-lock"></span> &nbsp; Forgot password?</a> ';
						}
						?>
		...
		<div id="navbar" class="row" style="background-color: #f1885b">
			<div class="col-lg-12" >
				<nav class="nav nav-pills nav-fill">
					<a class="nav-item nav-link" href="home.php"><img src="[navbar] hotptomo.png" height="50px" width="70px"></a>
					<a class="nav-item nav-link active" href="pasta.php"><img src="[navbar] pasta.png" height="50px" width="70px"></a>
	...
	<div class="col-md-12" style="background-color: black; margin-bottom: 200px;"></div>
		...
		<div class="col-sm-10">
			<div id="carousel1" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					...
					<div class="carousel-item">
						<img class="d-block w-100" src="banner5.jpg" >
					</div>
				</div>
	...
	<div class="col-md-12" style="z-index: 0;">
		...
		<div class="col-md-10">
			<?php
				...
				$result = mysqli_query($con, "SELECT * FROM menupasto WHERE category = 1;");
				$item = "";
				$counter = 1;
				$countercol = 1;
				while($row = mysqli_fetch_array($result)){
				if($item != $row['item'] && $counter % 2 != 0){
					echo '<br>
					<div id="isi" class="row justify-content-md-center">
					<div class="col-md-6 d-flex justify-content-center" >
					<div class="row justify-content-md-center">
						<div class="col-md-6 d-flex justify-content-center" >
							<img src="'.$row['photo'].'"" width="150px">
						</div>
						<div class="col-md-6 d-flex justify-content-center" >
						'
						.$row['item'].'<br>'.$row['descript'].
						'
						</div>
						<div class="row justify-content-md-center">
							...
							<div class="col-md-5" >
								<b>Rp. '.$row['price'].'/pax</b>
							</div>
							<div class="col-md-4 justify-content-left" >
								<!-- <img src = "addtoorder.png" height="25px"> -->
								
								<!-- Trigger the modal with a button -->
								<button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal'.$counter++.'"><img src = "addtoorder.png" height="25px"></button>
							</div>
						</div>
					</div>
				</div>	';
				}
				elseif($item != $row['item'] && $counter % 2 == 0){
					echo '<br>
				<div class="col-md-6 d-flex justify-content-center" >
					<div class="row justify-content-md-center">
						<div class="col-md-6 d-flex justify-content-center" >
	...
	<?php
				...
				while($row = mysqli_fetch_array($result)){
				if($item != $row['item']){
				echo '<div class="modal fade col-md-12" id="myModal'.$counter.'" role="dialog">
									...
									<form action="cart.php" method="POST">
										<div class="row justify-content-md-center">
											<div class="col-md-6 justify-content-center" >
												<img src="menu'.$counter.'.png" width="200px">
											</div>
											<div class="col-md-6 justify-content-center" >
												'.$row['item'].' <br>
												Rp. '.$row['price'].' /pax
											...
											<div class="row justify-content-md-center">
												...
												<div class="col-md-3 justify-content-center">
													<input type="text"  id="quantity" name="quantity" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" placeholder="Quantity">
												</div>
												<div class="col-md-4 d-flex justify-content-right" >
													<select id="lunch" name="lunch" class="selectpicker" title="select sauce">
														<option value="1">Bolognese</option>
														<option value="2">Mushroom</option>
														<option value="3">Korean</option>
														<option value="4">Chesee</option>
														<option value="5">Salted Egg</option>
														<option value="6">Curry</option>
													</select>
												</div>
												<div class="col-md-4 justify-content-left" >
													<input type="submit" class="btn btn-success" data-toggle="modal" data-target="#myModal'.$counter++.'" name="addtocart" id="addtocart" value="Confirm">
												</div>
											</div>
										</div>
									</form>
