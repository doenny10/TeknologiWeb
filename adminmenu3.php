					...
					<nav class="nav nav-pills nav-fill">
						...
						<li class="nav-item dropdown active">
					        ...
					        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					          ...
					          <a class="dropdown-item active" href="adminmenu3.php"><img src="[navbar] drink.png" height="50px" width="70px">Drink</a>
					        </div>
				      </li>
					</nav>
				</div>
		...
		<div class="col-md-12">
			...
			<tbody style="border:3px solid black;">
  				<?php
  					...
  					$result = mysqli_query($con, "SELECT * FROM menupasto WHERE category = 3;");
  				?>
