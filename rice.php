 				 		...
 				 		<?php
   					 	...
   					 	if(isset($_SESSION['user'])){
   					 		echo '<form class="px-4 py-3" action="database.php" method="POST">
							  		...
							  		<button class="dropdown-item" name="destroyrice" id="destroyrice" href="database.php"><span class="fa fa-sign-out"></span> Log Out </button>
							  </form>';   					 		
   					 	}
   					 	elseif(empty($_SESSION['user'])){
   					 		echo '<form class="px-4 py-3" action="database.php" method="POST">
						    ...
						    <button type="submit" class="btn btn-primary" name="signinrice" id="signinrice"><span class="fa fa-user-circle"></span> Sign in</button> 
						</form>
			...
			<div id="navbar" class="row" style="background-color: #f1885b">
				<div class="col-lg-12" >
					<nav class="nav nav-pills nav-fill">
						...
						<a class="nav-item nav-link active" href="rice.php"><img src="[navbar] rice.png" height="50px" width="70px"></a>
			...
			<div class="col-sm-10">
				...
				<div id="isi" class="row justify-content-md-center">
					<div class="col-md-6 d-flex justify-content-center" >
						...
						<div class="col-md-6 d-flex justify-content-center" >
				      		<a href="#"><img src="rice1.png" width="200px"></a>
				      	</div>
				      	<div class="col-md-6 d-flex justify-content-center" >
				      		CHICKEN CURRY
							<br>
					      	Rice Box berisi nasi dan ayam yang digoreng dengan balutan tepung dan ditambah siraman saus curry
				      	</div>
   						 <div class="row justify-content-md-center">
				    ...
				    <div class="col-md-6 d-flex justify-content-center" >
						<div class="row justify-content-md-center">
						<div class="col-md-6 d-flex justify-content-center" >
				      		<a href="#"><img src="rice2.png" width="200px"></a>
				      	</div>
				      	<div class="col-md-6 d-flex justify-content-center" >
				      		FISH CAKE CHESE
							<br>
					      	Rice Box berisi nasi dan Fish cake yang dpanggang sempurna dan ditambah siraman sauce keju
				      	</div>
   						 <div class="row justify-content-md-center">
					...
					<div class="col-md-6 d-flex justify-content-center" >
						<div class="row justify-content-md-center">
						<div class="col-md-6 d-flex justify-content-center" >
				      		<a href="#"><img src="rice3.png" width="200px"></a>
				      	</div>
				      	<div class="col-md-6 d-flex justify-content-center" >
				      		HAM
							<br>
					      	Rice Box berisi nasi dan daging ham dan ditambah siraman saus special
				      	</div>
   						 <div class="row justify-content-md-center">
   						 	<div class="col-md-6 justify-content-center" >
   						 		<b>Rp. 50.000</b>
				    ...
				    <div class="col-md-6 d-flex justify-content-center" >
						<div class="row justify-content-md-center">
						<div class="col-md-6 d-flex justify-content-center" >
				      		<a href="#"><img src="rice4.png" width="200px"></a>
				      	</div>
				      	<div class="col-md-6 d-flex justify-content-center" >
				      		CHICKEN RENDANG
							<br>
					      	Rice Box berisi nasi dan ayam yang digoreng dengan balutan tepung dan ditambah siraman saus rendang yang bikin nendang
				      	</div>
   						 <div class="row justify-content-md-center">
   						 	<div class="col-md-6 justify-content-center" >
   						 		<b>Rp. 50.000</b>
					...
					<div class="col-md-6 d-flex justify-content-center" >
						<div class="row justify-content-md-center">
						<div class="col-md-6 d-flex justify-content-center" >
				      		<a href="#"><img src="rice5.png" width="200px"></a>
				      	</div>
				      	<div class="col-md-6 d-flex justify-content-center" >
				      		CHICKEN CUBE SALTED EGG
							<br>
					      	Rice Box berisi nasi dan potongan daging ayam yang dipanggang dan ditambah siraman salted egg
				      	</div>
   						 <div class="row justify-content-md-center">
   						 	<div class="col-md-6 justify-content-center" >
   						 		<b>Rp. 50.000</b>
						...
						<div class="col-md-6 d-flex justify-content-center" >
				      	...
				      	<div class="col-md-6 d-flex justify-content-center" >
   						 ...
   						 <div class="row justify-content-md-center">
   						 	...
   						 	<!--<div class="col-md-4 justify-content-left" >
   						 		<img src = "addtoorder.png" height="40px">
   						 	</div>-->
   						 </div>
				      	</div>
				    </div>
